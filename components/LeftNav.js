			...
			<div className={styles.navbar}>
				...
				>
						...
						<svg width="24" height="25" viewBox="0 0 24 25" 
							...
							<path d="M20 6.91797C21.2426 6.91797 22.25 5.91061 22.25 4.66797C22.25 3.42533 21.2426 2.41797 20 2.41797C18.7574 2.41797 17.75 3.42533 17.75 4.66797C17.75 5.91061 18.7574 6.91797 20 6.91797Z" 
								fill={router.pathname.includes('/datasets/')? '#5A00E2': '#474F5A'}/>
							<path d="M20 22.918C21.2426 22.918 22.25 21.9106 22.25 20.668C22.25 19.4253 21.2426 18.418 20 18.418C18.7574 18.418 17.75 19.4253 17.75 20.668C17.75 21.9106 18.7574 22.918 20 22.918Z" 
								fill={router.pathname.includes('/datasets/')? '#5A00E2': '#474F5A'}/>
							<path d="M4 14.918C5.24264 14.918 6.25 13.9106 6.25 12.668C6.25 11.4253 5.24264 10.418 4 10.418C2.75736 10.418 1.75 11.4253 1.75 12.668C1.75 13.9106 2.75736 14.918 4 14.918Z" 
								fill={router.pathname.includes('/datasets/')? '#5A00E2': '#474F5A'}/>
							<path opacity="0.4" d="M19 13.418C19.41 13.418 19.75 13.078 19.75 12.668C19.75 12.258 19.41 11.918 19 11.918H11.75V7.66797C11.75 6.08797 12.42 5.41797 14 5.41797H19C19.41 5.41797 19.75 5.07797 19.75 4.66797C19.75 4.25797 19.41 3.91797 19 3.91797H14C11.58 3.91797 10.25 5.24797 10.25 7.66797V11.918H5C4.59 11.918 4.25 12.258 4.25 12.668C4.25 13.078 4.59 13.418 5 13.418H10.25V17.668C10.25 20.088 11.58 21.418 14 21.418H19C19.41 21.418 19.75 21.078 19.75 20.668C19.75 20.258 19.41 19.918 19 19.918H14C12.42 19.918 11.75 19.248 11.75 17.668V13.418H19Z" 
								fill={router.pathname.includes('/datasets/')? '#5A00E2': '#474F5A'}/>
							</svg>
