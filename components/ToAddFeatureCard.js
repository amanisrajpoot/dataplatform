...
export default function ToAddFeatureCard(props){
    ...
    return (
          ...
          <div style={{display:"flex", flexDirection:'row', minHeight:'14vh',maxHeight:'14vh', width:"98%",
              ...
              <div style={{flexDirection:'column',display:'flex',justifyContent:'center', maxHeight:'6px', minWidth:'7%',
                  ...
                  <Button sx={{borderRadius:2,minWidth:'48px',maxWidth:'48px',minHeight:'36px',backgroundColor:"#5A00E2", color:"#fff"}}
                    ...
                    <div style={{fontSize:"1em", minWidth:"47%", overflow:'hidden', display:'flex', flexDirection:'column',flex:'start'}}>
                        <div style={{textOverflow:'clip', overflow:'hidden',paddingBottom:8}}><b>{props.data.title?props.data.title.substring(0,89): "FDA Approved Drugs"}</b></div>
                        <div style={{paddingBottom:8, color:'#939EAA'}}>{props.data.description?props.data.description.substring(0,39)+"..":"FDA has been very responsible in controlling drug flow"}</div>
