...
export default function Output() {
  ...
  return (
    ...
    <div style={{ paddingTop: 48, paddingLeft: 8, paddingRight: 8, paddingBottom: 8,
        bgcolor: '#eaeff1',width:'100%', display:'flex',  }}>
          
          <div style={{paddingTop: 8, paddingLeft: 24, paddingRight: 4, paddingBottom: 8,
             bgcolor: '#eaeff1',width:'35%' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', width:'65%',
            mb:4, minWidth:'24ch', paddingLeft:32, paddingRight:32, }}>
