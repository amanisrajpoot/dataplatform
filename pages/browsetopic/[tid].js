                    ...
                    <Box>
                        ...
                        <Box sx={{ display: 'flex', flexDirection:'row', py: 2,px:2, bgcolor: 'gray-900', width:'100%',
                            ...
                            <Box sx={{ display: 'flex', flexDirection:'row', font:'roboto', fontSize:18,
                                color:'gray-700',justifyContent:'space-around', alignItems:'center',width:'100%'}}>
                                <Button sx={{backgroundColor:"#E4F7FF",
                                    borderRadius:4, border:1, fontSize:24, fontWeight:"bold", mr:1,
                                    color:'#24BBFF'}}
                                        size="large"

                                    onClick={()=>router.push(`/browsetopic/Medication`)}>{"Medication"}</Button>
                                ...
                                <Button sx={{backgroundColor:"#E4F7FF",
                                    ...
                                    onClick={()=>router.push(`/browsetopic/Drugs`)}>{"Drugs"}</Button>

                                <Button sx={{backgroundColor:"#E4F7FF",
                                    borderRadius:4, border:1, fontSize:24, fontWeight:"bold", mr:1,
                                    color:'#24BBFF'}}
                                        size="large"
                                        onClick={()=>router.push(`/browsetopic/Medication`)}
                                >{"Insaurance Companies"}</Button>

                                <Button sx={{backgroundColor:"#E4F7FF",
                                    borderRadius:4, border:1, fontSize:24, fontWeight:"bold", mr:1,
                                    color:'#24BBFF'}}
                                        size="large"
                                        onClick={()=>router.push(`/browsetopic/FDA`)}
                                >{"FDA"}</Button>
